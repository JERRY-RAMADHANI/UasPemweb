...
<body>
    ...
    <div class="oval-container1">
            <h1>Profile Family</h1>
            <div class="oval-container2">
                <div class="profile-info">
                    <h2>Kepala Keluarga</h2>
                    <p><label>Nama :</label> Dimas Aji Primadiansyah</p>
                    <p><label>NIK :</label> 3525150505030001</p>
                </div>
            </div>
            <div class="oval-container2">
                <div class="profile-info">
                    <h2>Wakil Keluarga</h2>
                    <p><label>Nama :</label> Erlang Diandaru</p>
                    <p><label>NIK :</label> 2178381819922221</p>
                </div>
            </div>
            <div class="oval-container2">
                <div class="profile-info">
